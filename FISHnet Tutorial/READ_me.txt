...
1) A requirments.txt file that indicate the python packages needed to run FISHnet.


2) Supplementary python scripts that are used to run FISHnet (housed in the folder called FISHnet) through the main script entitled:   
...
3) The FISHnet_Tutorial_notebook.ipynb in a juypter notebook.

4) HCT116_chr21_X.txt which is the Bintu 2018 HCT116 Chr21:34.6-37.1 Mb Dataset used in the tutorial.
